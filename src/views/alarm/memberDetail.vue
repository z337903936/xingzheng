      ...
      <div class="createPost-main-container">
        ...
        <div class="postInfo-container">
          ...
          <el-form-item label="短信内容" prop="smsContent">
            <el-input v-model="postForm.smsContent" :autosize="{ minRows: 2, maxRows: 4}" :value="smsContentChange"  type="textarea"/>
          </el-form-item>
          <el-divider>案件信息</el-divider>
          <el-form-item label="案件类型" prop="caseCategory">
            <el-select v-model="postForm.caseCategory" class="filter-item"  >
              <el-option
                      v-for="item in userList"
                      :key="item.id"
                      :label="item.title"
