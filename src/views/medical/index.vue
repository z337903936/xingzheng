    ...
    <div class="filter-container">
      <div>
        ...
        <el-input
          ...
          @keyup.enter.native="handleFilter"/>
        <el-input
          v-model="listQuery.delegateResult"
          placeholder="鉴定结论"
          class="mb10"
          style="width: 200px;"
          @keyup.enter.native="handleFilter"/>
        <!-- <el-input
          v-model="listQuery.delegateName"
          placeholder="委托人"
          class="mb10"
          style="width: 200px;"
          @keyup.enter.native="handleFilter"/>
        <el-input
          v-model="listQuery.digest"
          placeholder="简要案情"
          class="mb10"
          style="width: 200px;"
          @keyup.enter.native="handleFilter"/>
        <el-input
          v-model="listQuery.injure"
          placeholder="伤者情况"
          class="mb10"
          style="width: 200px;"
          @keyup.enter.native="handleFilter"/>
        <el-input
          v-model="listQuery.delegateTarget"
          placeholder="委托目的"
          class="mb10"
          style="width: 200px;"
          @keyup.enter.native="handleFilter"/>
