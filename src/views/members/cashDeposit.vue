    ...
    <el-form ref="postForm" :model="postForm" :rules="rules" class="form-container">
      <div class="createPost-main-container">
        <div class="postInfo-container">
          ...
          <el-row>
            <el-col :span="8">
              <el-form-item style="margin-bottom: 40px;" label-width="150px" label="充值类型:">
                现金
              </el-form-item>
            </el-col>
          </el-row>
          ...
          <el-row>
            <el-col :span="8">
              <el-form-item style="margin-bottom: 40px;" label-width="100px">
                <el-button v-loading="loading" style="width: 100%" type="primary" @click="submitForm">充值现金
                </el-button>
              </el-form-item>
            </el-col>
          </el-row>
...
<script>
  import { fetchMembers, cashDeposit } from '@/api/members'
