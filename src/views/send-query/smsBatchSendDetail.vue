<template>
  <div class="app-container">
    ...
    <el-table v-loading="listLoading" :data="list" border fit highlight-current-row style="width: 100%" stripe >
      ...
      <el-table-column align="center" label="运营商Id">
        <template slot-scope="scope">
      ...
      <el-table-column align="center" label="状态描述">
        <template slot-scope="scope">
      ...
      <el-table-column align="center" label="发送时间" min-width="100px">
        <template slot-scope="scope">
      ...
      <el-table-column align="center" label="到达时间" min-width="100px">
        <template slot-scope="scope">
...
<script>
  import { listSMSSendResultDetail } from '@/api/stat'
  ...
  export default {
    ...
    methods: {
      getList() {
        ...
        listSMSSendResultDetail(param).then(data => {
          this.list = data.list
