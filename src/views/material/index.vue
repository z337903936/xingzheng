  ...
  <div class="app-container">
    <div class="filter-container">
      <div>
        ...
        <el-input
          v-model="listQuery.storagePlace"
          placeholder="物证库"
          class="mb10"
          style="width: 200px;"
          @keyup.enter.native="handleFilter"/>
    ...
    >
      ...
      <el-table-column label="操作" align="center" width="330" fixed="right" class-name="small-padding fixed-width">
        <template slot-scope="{row}">
          ...
          <el-button v-waves v-if="row.status === 1" type="success" style="width: 70px" size="mini" @click="agreeIn(row)" >
            同意
          </el-button>
          <el-button v-waves v-if="row.status === 1" type="warning" style="width: 70px;margin-left: 0" size="mini" @click="denyIn(row)">
            拒绝
          </el-button>
        </template>
      </el-table-column>
