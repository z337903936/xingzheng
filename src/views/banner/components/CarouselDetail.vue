      ...
      <div class="createPost-main-container">
        ...
        <div class="postInfo-container">
          ...
          <el-row>
            ...
            <el-col :span="6">
              <el-form-item style="margin-bottom: 40px;" label-width="100px" label="客户端:">
                <el-select v-model="postForm.type">
                  <el-option key="1" label="PC端" value="1"/>
                  <el-option key="2" label="手机端" value="2"/>
                </el-select>
              </el-form-item>
            </el-col>
            <el-col :span="6">
          ...
          <el-row>
            <el-col :span="18">
              <el-form-item style="margin-bottom: 40px;" label-width="100px" label="PC端图片 1920*1000">
          ...
          <el-row>
            <el-col :span="18">
              <el-form-item style="margin-bottom: 40px;" label-width="100px" label="手机端图片 1366*600">
