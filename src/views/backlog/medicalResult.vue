        ...
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            <el-form-item label="委托单位" prop="delegateOrg">
              <!-- <el-select
                v-model="resultFrom.delegateOrg"
        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="委托人" prop="delegateName">
              <el-input v-model="resultFrom.delegateUid"/>
            </el-form-item>
          </el-col>
          <el-col :span="12">
  ...
  methods: {
    fetchData(id) {
      medicalDetails(id).then(data => {
        if (data.documentDate && data.documentDate.toString().length === 10) { data.documentDate = data.documentDate * 1000 }
        if (data.delegateTime && data.delegateTime.toString().length === 10) { data.delegateTime = data.delegateTime * 1000 }
    ...
    submitForm() {
      ...
      if (data.delegateTime.toString().length > 10) { data.delegateTime = parseInt(data.delegateTime / 1000) }
