    ...
    <el-form ref="postForm" :model="postForm" :rules="rules" class="form-container">
      <div class="createPost-main-container">
        <div class="postInfo-container">
          ...
          <el-row>
            <el-col :span="6">
              <el-form-item style="margin-bottom: 40px;" label-width="100px" label="来源:" prop="source">
                <el-input :rows="1" v-model="postForm.source" autosize placeholder="选填，请输入文章"/>
              </el-form-item>
            </el-col>
            <el-col :span="6">
              <el-form-item style="margin-bottom: 40px;" label-width="100px" label="发布时间:" prop="publishTime">
                <el-date-picker
            ...
            <el-col :span="6">
              <el-form-item style="margin-bottom: 40px;" label-width="100px" label="是否置顶:">
                <el-select v-model="postForm.isTop">
          ...
          <el-row>
            ...
            <el-col :span="6">
              <el-form-item style="margin-bottom: 40px;" label-width="100px" prop="status" label="是否启用:">
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        process: [{ validator: validateRequire }],
        partment: [{ validator: validateRequire }],
        telephone: [{ validator: validateRequire }],
        productAddress: [{ validator: validateRequire }],
        sellAddress: [{ validator: validateRequire }],
        flag: [{ validator: validateRequire }],
        categoryId: [{ validator: validateRequire }],
        status: [{ validator: validateRequire }],
        content: [{ validator: validateRequire }],
        digest: [{ validator: validateRequire }],
