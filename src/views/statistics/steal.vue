...
<script>
    ...
    import {stealStatistics} from '@/api/statistics'
    import waves from '@/directive/waves' // waves directive
    import {parseTime} from '@/utils'

    export default {
        name: "stealStatistics",
        directives: {waves},
        data(){
            return{
                list:null,
        ...
        methods:{
            ...
            handleCurrentChange(row){
                this.$router.push({ name:'stealDetail',query: { detail:JSON.stringify(row.detailList)}})
            },
            ...
            getList() {
                ...
                stealStatistics(this.listQuery).then(response => {
