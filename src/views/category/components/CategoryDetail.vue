      ...
      <div class="createPost-main-container">
        ...
        <div class="postInfo-container">
          <el-row>
            ...
            <el-col :span="9">
              <el-form-item style="margin-bottom: 40px;" label-width="100px" label="顶级分类:">
                <el-select :rows="1" v-model="postForm.categoryType">
                  <el-option key="1" label="新闻" value="1" />
                  <el-option key="2" label="集团项目" value="2" />
                </el-select>
              </el-form-item>
            </el-col>
          </el-row>
          ...
          <el-row>
            <el-col :span="18">
              <el-form-item style="margin-bottom: 40px;" label-width="100px" label="分类介绍图">
...
import { fetchCategory, updateCategory, addCarousel } from '@/api/category'
...
export default {
  ...
  methods: {
    ...
    setTagsViewTitle() {
      const title = this.lang === 'zh' ? '修改分类' : 'Edit Category'
