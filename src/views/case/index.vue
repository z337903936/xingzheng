  ...
  <div class="app-container">
    <div class="filter-container">
      <div class="mb10">
        ...
        />
        <el-input v-model="listQuery.title" placeholder="带班领导" style="width: 200px;margin-left: 5px" @keyup.enter.native="handleFilter" />
      </div>

      <div>
        <el-input v-model="listQuery.title" placeholder="接警人" style="width: 200px;" @keyup.enter.native="handleFilter" />
        <el-input v-model="listQuery.title" placeholder="报告单位" style="width: 200px;" @keyup.enter.native="handleFilter" />
    ...
    >
      <el-table-column label="任务单号" prop="id" sortable="custom" align="center" width="80" :class-name="getSortClass('id')">
        <template slot-scope="{row}">
          <span>{{ row.id }}</span>
        </template>
      </el-table-column>
      <el-table-column label="警情号" min-width="50px">
        <template slot-scope="{row}">
          <span>{{ row.id }}</span>
        </template>
      </el-table-column>
      ...
      <el-table-column label="技术员" width="80px">
        <template slot-scope="{row}">
          <svg-icon v-for="n in + row.importance" :key="n" icon-class="star" class="meta-item__icon" />
        </template>
      </el-table-column>
      <el-table-column label="发案区划" class-name="status-col" width="100">
        <template slot-scope="{row}">
    ...
    <el-dialog title="新增接警" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="120px" style="width: 700px; margin-left:50px;">
        <el-row :gutter="20">
          <el-col :span="12">
          ...
          <el-col :span="12">
            <el-form-item label="警情号" prop="title">
        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="任务单号" prop="title">
              <el-input v-model="temp.title" />
            </el-form-item>
